            ...
            <ul className="mx-auto mt-6 grid max-w-screen-xl border-y border-gray-200 px-4 py-5 sm:grid-cols-2 md:grid-cols-3 md:px-6">
              <li>
                ...
                >
                  ...
                  "What are the most anticipated movies and TV shows set to
                  release this year?"
                </span>
                </a>
              </li>
              <li>
                ...
                >
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">
                  "What are the current trends in sustainable fashion and how
                  can consumers make more eco-friendly clothing choices?"
                </span>
                </a>
              </li>
              <li>
                ...
                >
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">
                  "What are some innovative plant-based recipes that are both
              ...
              <li>
                ...
                >
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">
                  "What are some effective strategies for maintaining mental
                  health and wellness in a fast-paced world?"
                </span>
                </a>
              </li>
              <li>
                ...
                >
                  ...
                  and how are they impacting various industries?"
                </span>
                </a>
              </li>
              <li>
                ...
                >
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">
                  "What are the top destinations for solo travelers looking for
